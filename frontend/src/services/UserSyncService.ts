...
export default class UserSyncService {
   ...
   */
  static syncSingleUser(user: User, oldEmail?: string, password?: string): void {
    try {
  ...
  private static syncWithDefaultUsers(users: User[], oldEmail?: string, specificUser?: User, password?: string): void {
    try {
      ...
      if (specificUser && password) {
        ...
        let role = 'user';
        if (specificUser.papeis.includes('admin')) role = 'admin';
        else if (specificUser.papeis.includes('supervisor')) role = 'supervisor';
        else if (specificUser.papeis.includes('collector') || specificUser.papeis.includes('operador')) role = 'collector';
        else if (specificUser.papeis.includes('seller') || specificUser.papeis.includes('vendedor')) role = 'seller';
   ...
   */
  static updateLoggedUser(user: User): void {
    try {
